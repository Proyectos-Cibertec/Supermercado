...
public class FrmConsultaCliente extends JInternalFrame implements ActionListener, KeyListener, MouseListener {
	/**
	 * 
	 */
	...
	public FrmConsultaCliente() {
		...
		this.btnCancelar.setIcon(new ImageIcon(FrmConsultaCliente.class.getResource("/iconos/btnSalir.png")));
		this.btnCancelar.addActionListener(this);
		this.btnCancelar.setBounds(10, 470, 133, 41);
