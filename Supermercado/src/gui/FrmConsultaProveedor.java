...
public class FrmConsultaProveedor extends JInternalFrame implements ActionListener, KeyListener, MouseListener {
	/**
	 * 
	 */
	...
	public FrmConsultaProveedor() {
		...
		this.btnCancelar.setIcon(new ImageIcon(FrmConsultaProveedor.class.getResource("/iconos/btnSalir.png")));
		this.btnCancelar.addActionListener(this);
		this.btnCancelar.setBounds(10, 470, 126, 42);
